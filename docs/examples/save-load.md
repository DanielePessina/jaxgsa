...
not exist and you get a `FileNotFoundError` raised from inside NumPy's
`savez_compressed`, several frames away from your own call:

```
FileNotFoundError: [Errno 2] No such file or directory: 'no_such_dir/sobol.npz'
```
