...
| Categorical inputs | Supported (pick-freeze on level codes) | Rejected | Rejected | Rejected | Rejected | Rejected | Rejected | Rejected | Rejected | Supported (one class per level) | Supported (one class per level) |
